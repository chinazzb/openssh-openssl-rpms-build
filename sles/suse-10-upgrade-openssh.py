...
class system:
    ...
    def config():
        ...
        #perl
        os.system("clear")
        checkPerl = os.system("cd /tmp/safe/ssh/perl* && ./configure.gnu --prefix=/usr/local/perl/ && make && make install")
        os.system("mv /usr/bin/perl /usr/bin/perl.bak  && cp /usr/local/perl/bin/perl /usr/bin/perl")
        if 0 != checkPerl:
            print("config perl fault...................................")
            os._exit(4)
